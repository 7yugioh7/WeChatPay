 ...
 * 直连微信支付对接工具类
 */
public class WeiXinPayUtils implements WeiXinPayCommonUtils {
    /**
     * 微信支付相关配置
     */
     ...
     * 工具实例
     */
    private static WeiXinPayUtils weixinpayUtils;
    /**
     * 日志记录工具
     */
     ...
     * 微信通知信息存储
     */
    private final static String WEIXIN_NOTIFY = "wechat-notify-info";
     ...
     */
    private static WeiXinPayUtils init() throws IOException {
     ...
     */
    public String placeOrder(String orderId, String openId, String appId, String mchId, String body, double totalFee, String ip, String notifyUrl, String weiXinKey) {
        JSONObject resultObject = new JSONObject();
        resultObject.put("source", resultWaiter.SOURCE);
        Map<String, String> validResult = checker.checkPlaceOrder(orderId, openId, appId, mchId, body, totalFee, ip, notifyUrl);
        ...
        Map<String, String> reqParams = getCreateOrderReqMap(orderId, openId, appId, mchId, body, fee, ip, notifyUrl, weiXinKey);
        ...
        return resultWaiter.placeOrder(retString, orderId, weiXinKey);
    }
    ...
    public String placeOrder(String orderId, double totalFee, String openId, String ip, String goodsBody, Map<String, String> payConfigMap) {
        ...
        return this.placeOrder(orderId, openId, payConfigMap.get("appId"), payConfigMap.get("mchId"), goodsBody, totalFee, ip, payConfigMap.get("notifyUrl"), payConfigMap.get("payKey"));
    }
     ...
     * @return 请求微信下单map
     */
    private Map<String, String> getCreateOrderReqMap(String orderId, String openId, String appId, String mchId, String body, int fee, String ip, String notifyUrl, String weiXinKey) {
     ...
     */
    public String queryOrder(String orderId, String wxOrderId, String appId, String mchId, String weiXinKey) {
        JSONObject resultObject = new JSONObject();
        resultObject.put("source", resultWaiter.SOURCE);
        Map<String, String> validResult = checker.checkQueryOrder(orderId, wxOrderId, appId, mchId);
        resultObject.put("success", false);
        if (validResult == null) {
            resultObject.put("message", "参数错误");
            return resultObject.toJSONString();
        ...
        Map<String, String> reqParams = getQueryOrderReqMap(orderId, wxOrderId, appId, mchId, weiXinKey);
        log.info("微信直连查询订单参数为  " + reqParams.toString(), NoticeType.NO.getValue(), false);
        String retString = HttpHelper.doXmlPost(reqParams, weixinpayVo.getQueryOrder());
        log.info("微信直连查询请求订单结果为  " + retString, NoticeType.NO.getValue(), false);
        return resultWaiter.queryOrder(retString, weiXinKey);
    }
    ...
    public String queryOrder(String orderId, String wxOrderId, Map<String, String> payConfigMap) {
        ...
        return this.queryOrder(orderId, wxOrderId, payConfigMap.get("appId"), payConfigMap.get("mchId"), payConfigMap.get("payKey"));
    }
     ...
     * @return 查询订单请求map
     */
    private Map<String, String> getQueryOrderReqMap(String orderId, String wxOrderId, String appId, String mchId, String weiXinKey) {
        TreeMap<String, String> reqParams = new TreeMap<>();
        reqParams.put("appid", appId);
        reqParams.put("mch_id", mchId);
     ...
     */
    public String closeOrder(String orderId, String appId, String mchId, String weiXinKey) {
        JSONObject resultObject = new JSONObject();
        resultObject.put("source", resultWaiter.SOURCE);
        Map<String, String> validResult = checker.checkCloseOrder(orderId, appId, mchId);
        resultObject.put("success", false);
        if (validResult == null) {
            resultObject.put("message", "参数错误");
            return resultObject.toJSONString();
        ...
        Map<String, String> reqParams = getCloseOrderReqMap(orderId, appId, mchId, weiXinKey);
        ...
        return resultWaiter.closeOrder(retString, weiXinKey);
    }
    ...
    public String closeOrder(String orderId, Map<String, String> payConfigMap) {
        ...
        return this.closeOrder(orderId, payConfigMap.get("appId"), payConfigMap.get("mchId"), payConfigMap.get("payKey"));
    }
     ...
     * @return 关闭订单请求map
     */
    private Map<String, String> getCloseOrderReqMap(String orderId, String appId, String mchId, String weixinKey) {
        TreeMap<String, String> reqParams = new TreeMap<>();
        reqParams.put("appid", appId);
        reqParams.put("mch_id", mchId);
        reqParams.put("out_trade_no", orderId);
     ...
     * @return 退款申请结果
     */
    public String refundOrder(String orderId, String wxOrderId, double refundFee, String appId, String mchId, String weiXinKey) {
        JSONObject resultObject = new JSONObject();
        resultObject.put("source", resultWaiter.SOURCE);
        Map<String, String> validResult = checker.checkRefundOrder(orderId, wxOrderId, refundFee, appId, mchId);
        resultObject.put("success", false);
        if (validResult == null) {
            resultObject.put("message", "参数错误");
            return resultObject.toJSONString();
        ...
        int totalFee = getOrderTotalFee(orderId, wxOrderId, appId, mchId, weiXinKey);
        if (totalFee < 1 || fee > totalFee) {
            resultObject.put("message", "参数错误");
            return resultObject.toJSONString();
        }
        String refundOrderId = IdGenerator.getInstance().getId();
        Map<String, String> reqParams = getRefundOrderReqMap(orderId, wxOrderId, refundOrderId, fee, totalFee, appId, mchId, weiXinKey);
        log.info("微信直连申请退款参数为  " + reqParams.toString(), NoticeType.NO.getValue(), false);
        String certificatePath = weixinpayVo.getCertificatePath() + "/" + appId + "/" + weixinpayVo.getCertificateName();
        ...
        return resultWaiter.refundOrder(retString, refundOrderId, weiXinKey);
    }
    ...
    public String refundOrder(String orderId, String wxOrderId, double refundFee, Map<String, String> payConfigMap) {
        ...
        return this.refundOrder(orderId, wxOrderId, refundFee, payConfigMap.get("appId"), payConfigMap.get("mchId"), payConfigMap.get("payKey"));
    }
     ...
     * @return 退款申请map
     */
    private Map<String, String> getRefundOrderReqMap(String orderId, String wxOrderId, String refundOrderId, int refundFee, int totalFee, String appId, String mchId, String weiXinKey) {
        TreeMap<String, String> reqParams = new TreeMap<>();
        reqParams.put("appid", appId);
        reqParams.put("mch_id", mchId);
        reqParams.put("out_trade_no", orderId);
     ...
     * @return 订单总金额
     */
    private int getOrderTotalFee(String orderId, String wxOrderId, String appId, String mchId, String weiXinKey) {
        try {
            String result = this.queryOrder(orderId, wxOrderId, appId, mchId, weiXinKey);
